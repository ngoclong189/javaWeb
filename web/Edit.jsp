                        ...
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alimentation" class="form-control" required>${detail.alimentation}</textarea>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="manager" style="float: left"><button type="button" class="btn btn-primary">Back to home</button></a>
                                        </div>
